...
/**
 * Az osztály a játék magja, implementálja a játékciklust és innen vezérelhetõ
 * az egész játék. State-ekkel dolgozik a képernyõkezelés megkönnyítése
 * érdekében.
 * 
 * @author Ács Ádám
 * 
...
public final class BattleCity extends Game {
    ...
    /**
     * Beállítja a state-t (képernyõt) és elvégzi a szükséges lépéseket, hogy
     * használható legyen.
     * 
     * @param state
     */
    ...
    /**
     * Minden state init-jét meghívja, így a játék elején betöltõdik minden.
     * Elõször a loading state lesz megjelenítve a végén pedig átadja a
     * vezérlést a menü state-nek. Innentõl a statek már önállóan tudnak
